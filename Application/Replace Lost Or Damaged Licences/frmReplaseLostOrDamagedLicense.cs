...
using static DVLD___Buseniss_Layer.clsLicense;

namespace DVLD
{
    public partial class frmReplaseLostOrDamagedLicense : Form
    {
        private int _NewLicenseID = -1;
        public frmReplaseLostOrDamagedLicense()
        {
            InitializeComponent();
        }
        ...
        private void frmReplaseLostOrDamagedLicense_Load(object sender, EventArgs e)
        {
        ...
        private void frmReplaseLostOrDamagedLicense_Activated(object sender, EventArgs e)
        {
        ...
        private void llShowLicenseHistory_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                MessageBox.Show("You Should Select a Person");
                return;
            }
