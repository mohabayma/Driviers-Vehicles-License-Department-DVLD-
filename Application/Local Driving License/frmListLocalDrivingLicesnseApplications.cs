...
namespace DVLD
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            ...
            CancelApplicaitonToolStripMenuItem1.Enabled = (LocalDrivingLicenseApplication.ApplicationStatus == clsApplication.enApplicationStatus.New);
        ...
        private void dgvLocalDrivingLicenseApplications_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                dgvLocalDrivingLicenseApplications.ClearSelection(); // إلغاء التحديد السابق
                dgvLocalDrivingLicenseApplications.Rows[e.RowIndex].Selected = true; // تحديد الصف اللي ضغطت عليه
                dgvLocalDrivingLicenseApplications.CurrentCell = dgvLocalDrivingLicenseApplications.Rows[e.RowIndex].Cells[e.ColumnIndex]; // تعيين الخلية الحالية
            }
        }
        ...
        private void dgvLocalDrivingLicenseApplications_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (hit.RowIndex >= 0)
                {
                    ...
                    contextMenuStrip1.Show(dgvLocalDrivingLicenseApplications, e.Location);
                }
            }
        }
...
new frmLocalDrivingLicenseApplicationInfo((int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value);
        ...
        private void CancelApplicaitonToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void contextMenuStrip1_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                 LocalDrivingLicenseApplicationID = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value;
            }
                clsLocalDrivingLicenseApplication LocalDrivingLicenseApplication =
                    clsLocalDrivingLicenseApplication.FindByLocalDrivingAppLicenseID
                                                    (LocalDrivingLicenseApplicationID);
