...
namespace DVLD
{
    public partial class ctrlPersonInfoWithFiltering : UserControl
    {
        ...
        public ctrlPersonInfoWithFiltering()
        {
            InitializeComponent();
        }
        ...
        private void ctrlPersonInfoWithFiltering_Load(object sender, EventArgs e)
        {
        ...
        {
            frmAddNewPerson frm1 = new frmAddNewPerson();
